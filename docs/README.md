...
| [`followups.md`](architecture/followups.md) | In-repo issue log for deferred work (GitHub Issues are disabled on the fork). FU-1: split the deeply-coupled `useDiagrams` core. |
